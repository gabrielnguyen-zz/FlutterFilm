...
class ManageActorTaskPage extends StatefulWidget {
  ...
  @override
  _ManageActorTaskState createState() => _ManageActorTaskState();
}

class _ManageActorTaskState extends State<ManageActorTaskPage> {
  ...
  var bloc = GetAllActorBloc();
  @override
  void initState() {
    // TODO: implement initState
    bloc.getAllActorFunction();
    super.initState();
  }
  @override
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context)
                        .push(
                          MaterialPageRoute(
                              builder: (context) => CreateActorPage()),
                        )
                        .then((value) => bloc.getAllActorFunction());
                  },
                ),
              ),
            ),
